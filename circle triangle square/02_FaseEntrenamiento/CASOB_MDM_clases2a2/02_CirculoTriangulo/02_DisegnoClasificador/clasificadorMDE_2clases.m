...
nombreFichero ='espacio_ccas_circ_trian.mat';
...
funcion_calcula_funciones_decision_MDM_clasificacion_binaria(XoIRed,YoIRed);
...
%% Guardamos los datos
save('./DatosGenerados/MDM_circ_trian.mat','XoIRed','YoIRed','espacioCcas','nombresProblemaOIRed','coeficientes_d12','d12');
